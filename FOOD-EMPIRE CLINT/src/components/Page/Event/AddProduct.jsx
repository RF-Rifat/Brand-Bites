...
const AddProduct = () => {
  const handleUpdateData = (event) => {
    ...
    const newItem = { name, image, brand, price, type, rating, description };
      ...
      <div className="grid">
        <main className="mx-auto w-5/6 flex flex-col items-center justify-center">
          <header className="my-2 lg:mt-6 lg:mb-2">
            <p className="text-xl md:text-2xl text-center font-extrabold text-warning tracking-tight lg:text-5xl font-serif">
              ADD PRODUCTS
            </p>
          </header>
          <form
